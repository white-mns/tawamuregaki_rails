...
ActiveRecord::Schema.define(version: 2019_01_01_032001) do
  ...
  create_table "enemies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["battle_no", "result_no", "generate_no"], name: "battle_no_eno"
  ...
  create_table "pages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["result_no", "battle_result"], name: "resultno_battleresult"
  ...
  create_table "parties", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["e_no", "result_no", "generate_no", "battle_no"], name: "eno_resultno"

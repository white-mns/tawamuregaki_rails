class PagesController < ApplicationController
  ...
  def index
    param_set
    @count	= Page.notnil().all_includes(params).where_members(@params_members).where_leader(@params_leader).where_fellows(@params_fellows).ransack(params[:q]).result.count()
    @search	= Page.notnil().all_includes(params).where_members(@params_members).where_leader(@params_leader).where_fellows(@params_fellows).page(params[:page]).ransack(params[:q])

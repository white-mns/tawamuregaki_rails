class PagesController < ApplicationController
  ...
  def index
    param_set
    @count	= Page.notnil().includes(:story, [party_members: :pc_name], [leader: :pc_name], [fellow_members: :pc_name], [enemy_members: [:enemy, :suffix]]).where_members(@params_members).where_leader(@params_leader).where_fellows(@params_fellows).ransack(params[:q]).result.count()
    @search	= Page.notnil().includes(:story, [party_members: :pc_name], [leader: :pc_name], [fellow_members: :pc_name], [enemy_members: [:enemy, :suffix]]).where_members(@params_members).where_leader(@params_leader).where_fellows(@params_fellows).page(params[:page]).ransack(params[:q])
